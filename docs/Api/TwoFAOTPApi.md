# BSG\Api\V2\TwoFAOTPApi

All URIs are relative to https://one-api.bsg.world, except if the operation defines another base path.

| Method | HTTP request | Description |
| ------------- | ------------- | ------------- |
| [**cancelOtp()**](TwoFAOTPApi.md#cancelOtp) | **POST** /api/2fa/authentications/{id}/cancel | Cancel the authentication session |
| [**otpList()**](TwoFAOTPApi.md#otpList) | **GET** /api/2fa/authentications | List of authentication sessions |
| [**resendOtp()**](TwoFAOTPApi.md#resendOtp) | **POST** /api/2fa/authentications/otp/{id}/resend | Resend the one-time code |
| [**sendOtp()**](TwoFAOTPApi.md#sendOtp) | **POST** /api/2fa/authentications/otp | Send One-time password |
| [**statusOtp()**](TwoFAOTPApi.md#statusOtp) | **GET** /api/2fa/authentications/{id} | Check authentication status |
| [**verifyOtp()**](TwoFAOTPApi.md#verifyOtp) | **POST** /api/2fa/authentications/otp/{id}/verify | Check one-time Code |
...
$apiInstance = new BSG\Api\V2\Api\TwoFAOTPApi(
...
try {
    ...
    echo 'Exception when calling TwoFAOTPApi->cancelOtp: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling TwoFAOTPApi->otpList: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling TwoFAOTPApi->resendOtp: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling TwoFAOTPApi->sendOtp: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling TwoFAOTPApi->statusOtp: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling TwoFAOTPApi->verifyOtp: ', $e->getMessage(), PHP_EOL;
}
```
