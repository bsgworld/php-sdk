# BSG\Api\V2\PostCampaignsWhatsappSendApi
...
$apiInstance = new BSG\Api\V2\Api\PostCampaignsWhatsappSendApi(
...
try {
    ...
    echo 'Exception when calling PostCampaignsWhatsappSendApi->postCampaignsWhatsappSend: ', $e->getMessage(), PHP_EOL;
}
```
