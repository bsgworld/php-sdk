# BSG\Api\V2\EmailTemplateSendApi
...
$apiInstance = new BSG\Api\V2\Api\EmailTemplateSendApi(
...
try {
    ...
    echo 'Exception when calling EmailTemplateSendApi->emailTemplateSend: ', $e->getMessage(), PHP_EOL;
}
```
