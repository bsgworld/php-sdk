...
/**
 * GetSettingsAddressBookFieldsByIdApi Class Doc Comment
 *
 * @category Class
 * @package  BSG\Api\V2
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class GetSettingsAddressBookFieldsByIdApi
{
    /**
     * @var ClientInterface
     */
    ...
    public function getSettingsAddressBookFieldsByIdRequest($id, string $contentType = self::contentTypes['getSettingsAddressBookFieldsById'][0])
    {
        ...
        if ($id < 1) {
            throw new \InvalidArgumentException('invalid value for "$id" when calling GetSettingsAddressBookFieldsByIdApi.getSettingsAddressBookFieldsById, must be bigger than or equal to 1.');
        }
        

        $resourcePath = '/api/settings/address-book-fields/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
