...
/**
 * ShortUrlsDomainsApi Class Doc Comment
 *
 * @category Class
 * @package  BSG\Api\V2
 * @author   OpenAPI Generator team
...
class ShortUrlsDomainsApi
{
    ...
    public function shortUrlsDomainsRequest($from, $to, $page = 1, $per_page = 20, string $contentType = self::contentTypes['shortUrlsDomains'][0])
    {
        ...
        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling ShortUrlsDomainsApi.shortUrlsDomains, must be bigger than or equal to 1.');
        }
        
        if ($per_page !== null && $per_page < 10) {
            throw new \InvalidArgumentException('invalid value for "$per_page" when calling ShortUrlsDomainsApi.shortUrlsDomains, must be bigger than or equal to 10.');
        }
