...
class CampaignsApi
{
     ...
     * @return \BSG\Api\V2\Model\SearchCampaignResource
     */
     ...
     * @throws \BSG\Api\V2\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \BSG\Api\V2\Model\SearchCampaignResource, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function campaignsRequest($page_offset = 0, $page_limit = 50, $sort = 'id', $way = null, $filter_from = null, $filter_to = null, $filter_type = null, $search_field = null, $search_value = null, string $contentType = self::contentTypes['campaigns'][0])
    {
        ...
        if ($page_offset !== null && $page_offset < 0) {
            throw new \InvalidArgumentException('invalid value for "$page_offset" when calling CampaignsApi.campaigns, must be bigger than or equal to 0.');
        }
        
        if ($page_limit !== null && $page_limit > 500) {
            throw new \InvalidArgumentException('invalid value for "$page_limit" when calling CampaignsApi.campaigns, must be smaller than or equal to 500.');
        }
        if ($page_limit !== null && $page_limit < 30) {
            throw new \InvalidArgumentException('invalid value for "$page_limit" when calling CampaignsApi.campaigns, must be bigger than or equal to 30.');
        }
        ...
        if ($search_value !== null && strlen($search_value) > 255) {
            throw new \InvalidArgumentException('invalid length for "$search_value" when calling CampaignsApi.campaigns, must be smaller than or equal to 255.');
        }
        if ($search_value !== null && strlen($search_value) < 1) {
            throw new \InvalidArgumentException('invalid length for "$search_value" when calling CampaignsApi.campaigns, must be bigger than or equal to 1.');
        }
