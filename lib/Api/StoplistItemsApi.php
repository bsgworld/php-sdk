...
/**
 * StoplistItemsApi Class Doc Comment
 *
 * @category Class
 * @package  BSG\Api\V2
 * @author   OpenAPI Generator team
...
class StoplistItemsApi
{
    ...
    public function stoplistItemsRequest($page_offset = 0, $page_limit = 20, $type = null, string $contentType = self::contentTypes['stoplistItems'][0])
    {
        ...
        if ($page_offset !== null && $page_offset < 0) {
            throw new \InvalidArgumentException('invalid value for "$page_offset" when calling StoplistItemsApi.stoplistItems, must be bigger than or equal to 0.');
        }
        
        if ($page_limit !== null && $page_limit > 500) {
            throw new \InvalidArgumentException('invalid value for "$page_limit" when calling StoplistItemsApi.stoplistItems, must be smaller than or equal to 500.');
        }
        if ($page_limit !== null && $page_limit < 15) {
            throw new \InvalidArgumentException('invalid value for "$page_limit" when calling StoplistItemsApi.stoplistItems, must be bigger than or equal to 15.');
        }
