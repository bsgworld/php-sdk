...
/**
 * StoplistSearchApi Class Doc Comment
 *
 * @category Class
 * @package  BSG\Api\V2
 * @author   OpenAPI Generator team
...
class StoplistSearchApi
{
    ...
    public function stoplistSearchRequest($page_offset = 0, $page_limit = 50, $sort = 'id', $way = null, $contact_group_id = null, $search_field = null, $search_operator = null, $search_value = null, $search_fields_0_field = null, $search_fields_0_operator = null, $search_fields_0_value = null, string $contentType = self::contentTypes['stoplistSearch'][0])
    {
        ...
        if ($page_offset !== null && $page_offset < 0) {
            throw new \InvalidArgumentException('invalid value for "$page_offset" when calling StoplistSearchApi.stoplistSearch, must be bigger than or equal to 0.');
        }
        
        if ($page_limit !== null && $page_limit > 500) {
            throw new \InvalidArgumentException('invalid value for "$page_limit" when calling StoplistSearchApi.stoplistSearch, must be smaller than or equal to 500.');
        }
        if ($page_limit !== null && $page_limit < 15) {
            throw new \InvalidArgumentException('invalid value for "$page_limit" when calling StoplistSearchApi.stoplistSearch, must be bigger than or equal to 15.');
        }
