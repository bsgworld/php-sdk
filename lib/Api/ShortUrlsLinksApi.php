...
/**
 * ShortUrlsLinksApi Class Doc Comment
 *
 * @category Class
 * @package  BSG\Api\V2
 * @author   OpenAPI Generator team
...
class ShortUrlsLinksApi
{
    ...
    public function shortUrlsLinksRequest($from, $to, $page = 1, $per_page = 20, string $contentType = self::contentTypes['shortUrlsLinks'][0])
    {
        ...
        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling ShortUrlsLinksApi.shortUrlsLinks, must be bigger than or equal to 1.');
        }
        
        if ($per_page !== null && $per_page < 10) {
            throw new \InvalidArgumentException('invalid value for "$per_page" when calling ShortUrlsLinksApi.shortUrlsLinks, must be bigger than or equal to 10.');
        }
