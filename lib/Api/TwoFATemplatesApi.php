...
/**
 * TwoFATemplatesApi Class Doc Comment
 *
 * @category Class
 * @package  BSG\Api\V2
 * @author   OpenAPI Generator team
...
class TwoFATemplatesApi
{
    ...
    public function otpTemplateListRequest($page_offset = 0, $page_limit = 10, $filter_ids = null, $filter_status = null, $sort = 'template_id', $way = null, string $contentType = self::contentTypes['otpTemplateList'][0])
    {
        ...
        if ($page_offset !== null && $page_offset < 0) {
            throw new \InvalidArgumentException('invalid value for "$page_offset" when calling TwoFATemplatesApi.otpTemplateList, must be bigger than or equal to 0.');
        }
        
        if ($page_limit !== null && $page_limit > 500) {
            throw new \InvalidArgumentException('invalid value for "$page_limit" when calling TwoFATemplatesApi.otpTemplateList, must be smaller than or equal to 500.');
        }
        if ($page_limit !== null && $page_limit < 10) {
            throw new \InvalidArgumentException('invalid value for "$page_limit" when calling TwoFATemplatesApi.otpTemplateList, must be bigger than or equal to 10.');
        }
        
        if ($filter_ids !== null && count($filter_ids) > 100) {
            throw new \InvalidArgumentException('invalid value for "$filter_ids" when calling TwoFATemplatesApi.otpTemplateList, number of items must be less than or equal to 100.');
        }
        if ($filter_ids !== null && count($filter_ids) < 1) {
            throw new \InvalidArgumentException('invalid value for "$filter_ids" when calling TwoFATemplatesApi.otpTemplateList, number of items must be greater than or equal to 1.');
        }
