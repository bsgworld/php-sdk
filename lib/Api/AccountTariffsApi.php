...
/**
 * AccountTariffsApi Class Doc Comment
 *
 * @category Class
 * @package  BSG\Api\V2
 * @author   OpenAPI Generator team
...
class AccountTariffsApi
{
    ...
    public function accountTariffsRequest($page_offset = 0, $page_limit = 50, string $contentType = self::contentTypes['accountTariffs'][0])
    {
        ...
        if ($page_offset !== null && $page_offset < 0) {
            throw new \InvalidArgumentException('invalid value for "$page_offset" when calling AccountTariffsApi.accountTariffs, must be bigger than or equal to 0.');
        }
        
        if ($page_limit !== null && $page_limit > 500) {
            throw new \InvalidArgumentException('invalid value for "$page_limit" when calling AccountTariffsApi.accountTariffs, must be smaller than or equal to 500.');
        }
        if ($page_limit !== null && $page_limit < 15) {
            throw new \InvalidArgumentException('invalid value for "$page_limit" when calling AccountTariffsApi.accountTariffs, must be bigger than or equal to 15.');
        }
