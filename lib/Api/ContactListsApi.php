...
class ContactListsApi
{
    ...
    public function contactListsRequest($page_offset = 0, $page_limit = 50, string $contentType = self::contentTypes['contactLists'][0])
    {
        ...
        if ($page_offset !== null && $page_offset < 0) {
            throw new \InvalidArgumentException('invalid value for "$page_offset" when calling ContactListsApi.contactLists, must be bigger than or equal to 0.');
        }
        
        if ($page_limit !== null && $page_limit > 500) {
            throw new \InvalidArgumentException('invalid value for "$page_limit" when calling ContactListsApi.contactLists, must be smaller than or equal to 500.');
        }
        if ($page_limit !== null && $page_limit < 15) {
            throw new \InvalidArgumentException('invalid value for "$page_limit" when calling ContactListsApi.contactLists, must be bigger than or equal to 15.');
        }
