...
class Internal2FAApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['internal2faPrice'] to see the possible values for this operation
     *
    ...
    {
        list($response) = $this->internal2faPriceWithHttpInfo($channel_type, $currency, $tariff_code, $country_code, $operator_id, $contentType);
        return $response;
    }

    /**
     * Operation internal2faPriceWithHttpInfo
     *
     * Show 2FA authentication full price
     *
    ...
    /**
     * Operation internal2faPriceAsync
     *
     * Show 2FA authentication full price
     *
     * @param  string $channel_type (required)
     ...
     */
    public function internal2faPriceAsync($channel_type, $currency, $tariff_code = null, $country_code = null, $operator_id = null, string $contentType = self::contentTypes['internal2faPrice'][0])
    {
        return $this->internal2faPriceAsyncWithHttpInfo($channel_type, $currency, $tariff_code, $country_code, $operator_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation internal2faPriceAsyncWithHttpInfo
     *
     * Show 2FA authentication full price
     *
     * @param  string $channel_type (required)
    ...
    /**
     * Create request for operation 'internal2faPrice'
     *
     * @param  string $channel_type (required)
     * @param  string $currency (required)
     * @param  int|null $tariff_code (optional)
     ...
     */
    public function internal2faPriceRequest($channel_type, $currency, $tariff_code = null, $country_code = null, $operator_id = null, string $contentType = self::contentTypes['internal2faPrice'][0])
    {

        // verify the required parameter 'channel_type' is set
        if ($channel_type === null || (is_array($channel_type) && count($channel_type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $channel_type when calling internal2faPrice'
            );
        }
        ...
        if ($currency === null || (is_array($currency) && count($currency) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $currency when calling internal2faPrice'
            );
        }
