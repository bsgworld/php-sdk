...
/**
 * GetMessagesApi Class Doc Comment
 *
 * @category Class
 * @package  BSG\Api\V2
 * @author   OpenAPI Generator team
...
class GetMessagesApi
{
    ...
    public function getMessagesRequest($page_offset = 0, $page_limit = 50, $sort = 'id', $way = null, $filter_id = null, $filter_campaign_id = null, $filter_reference_id = null, $filter_from = null, $filter_to = null, string $contentType = self::contentTypes['getMessages'][0])
    {
        ...
        if ($page_offset !== null && $page_offset < 0) {
            throw new \InvalidArgumentException('invalid value for "$page_offset" when calling GetMessagesApi.getMessages, must be bigger than or equal to 0.');
        }
        
        if ($page_limit !== null && $page_limit > 500) {
            throw new \InvalidArgumentException('invalid value for "$page_limit" when calling GetMessagesApi.getMessages, must be smaller than or equal to 500.');
        }
        if ($page_limit !== null && $page_limit < 15) {
            throw new \InvalidArgumentException('invalid value for "$page_limit" when calling GetMessagesApi.getMessages, must be bigger than or equal to 15.');
        }
        


        if ($filter_id !== null && $filter_id < 1) {
            throw new \InvalidArgumentException('invalid value for "$filter_id" when calling GetMessagesApi.getMessages, must be bigger than or equal to 1.');
        }
