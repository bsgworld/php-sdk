 ...
 */
class TwoFaTemplateResource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TwoFaTemplateResource';
    ...
    */
     ...
     * Sets template_id
     *
     * @param int|null $template_id Unique, automatically generated by a system identifier of the template within the TwoFA service.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Name of the template.  A string of 3 to 50 characters.
     *
     * @return self
     */
     ...
     * Sets text
     *
     * @param string|null $text The text of the template message.
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param \DateTime|null $updated_at Date and time of the last change of the template in ISO 8601 format.
     *
     * @return self
     */
