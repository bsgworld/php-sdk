    ...
    */
    ...
    public function setPhone($phone)
    {
        ...
        if (($phone > 999999999999999)) {
            throw new \InvalidArgumentException('invalid value for $phone when calling ContactUpdaterequest., must be smaller than or equal to 999999999999999.');
        }
        if (($phone < 100000000)) {
            throw new \InvalidArgumentException('invalid value for $phone when calling ContactUpdaterequest., must be bigger than or equal to 100000000.');
        }
    ...
    public function setGroups($groups)
    {
        ...
        if ((count($groups) > 100)) {
            throw new \InvalidArgumentException('invalid value for $groups when calling ContactUpdaterequest., number of items must be less than or equal to 100.');
        }
