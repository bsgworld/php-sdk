...
class Rcs implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setCards($cards)
    {
        ...
        if ((count($cards) > 10)) {
            throw new \InvalidArgumentException('invalid value for $cards when calling Rcs., number of items must be less than or equal to 10.');
        }
        if ((count($cards) < 1)) {
            throw new \InvalidArgumentException('invalid length for $cards when calling Rcs., number of items must be greater than or equal to 1.');
        }
    ...
    public function setText($text)
    {
        ...
        if ((mb_strlen($text) > 160)) {
            throw new \InvalidArgumentException('invalid length for $text when calling Rcs., must be smaller than or equal to 160.');
        }
        if ((mb_strlen($text) < 1)) {
            throw new \InvalidArgumentException('invalid length for $text when calling Rcs., must be bigger than or equal to 1.');
        }
    ...
    public function setSender($sender)
    {
        ...
        if ((mb_strlen($sender) > 40)) {
            throw new \InvalidArgumentException('invalid length for $sender when calling Rcs., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($sender) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sender when calling Rcs., must be bigger than or equal to 1.');
        }
