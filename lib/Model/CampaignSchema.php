 ...
 */
class CampaignSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CampaignSchema';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('real_start_at', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['real_start_at'];
    }

    /**
     * Sets real_start_at
     *
     * @param \DateTime|null $real_start_at Real time when sending the messages starts
     *
     * @return self
     */
    public function setRealStartAt($real_start_at)
    {
        if (is_null($real_start_at)) {
            array_push($this->openAPINullablesSetToNull, 'real_start_at');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('real_start_at', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['real_start_at'] = $real_start_at;
     ...
     *
     * @param float|null $calculated_price estimate campaign cost  **Please note:** price defined only as the response to create campaign or calculate price requests
     *
     * @return self
     */
    public function setCalculatedPrice($calculated_price)
    {
        if (is_null($calculated_price)) {
            array_push($this->openAPINullablesSetToNull, 'calculated_price');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('calculated_price', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
