 ...
 */
class OtpTemplateCreaterequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets name
     *
     * @param string $name Name of the template.  A string of 3 to 50 characters.
     *
     * @return self
     */
     ...
     * Sets text
     *
     * @param string $text The text of the template message.
     *
     * @return self
     */
