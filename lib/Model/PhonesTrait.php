 ...
 */
class PhonesTrait implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PhonesTrait';
    ...
    */
    ...
    public function setPhones($phones)
    {
        ...
        if ((count($phones) > 10000)) {
            throw new \InvalidArgumentException('invalid value for $phones when calling PhonesTrait., number of items must be less than or equal to 10000.');
        }
        if ((count($phones) < 1)) {
            throw new \InvalidArgumentException('invalid length for $phones when calling PhonesTrait., number of items must be greater than or equal to 1.');
        }
