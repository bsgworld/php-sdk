 ...
 */
class SmsSendIndividualrequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['start_at']) && ($this->container['start_at'] > 72)) {
            $invalidProperties[] = "invalid value for 'start_at', must be smaller than or equal to 72.";
        }
    ...
    public function setValidity($validity)
    {
        ...
        if (($validity > 72)) {
            throw new \InvalidArgumentException('invalid value for $validity when calling SmsSendIndividualrequest., must be smaller than or equal to 72.');
        }
        if (($validity < 1)) {
            throw new \InvalidArgumentException('invalid value for $validity when calling SmsSendIndividualrequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets start_at
     *
     * @param int|null $start_at validity time in hours. The default is 72 hours. Integer from 1 to 72
     *
     * @return self
     */
    public function setStartAt($start_at)
    {
        ...
        if (($start_at > 72)) {
            throw new \InvalidArgumentException('invalid value for $start_at when calling SmsSendIndividualrequest., must be smaller than or equal to 72.');
        }
        if (($start_at < 1)) {
            throw new \InvalidArgumentException('invalid value for $start_at when calling SmsSendIndividualrequest., must be bigger than or equal to 1.');
        }
