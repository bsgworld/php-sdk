...
class Components implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['index']) && (mb_strlen($this->container['index']) > 9)) {
            $invalidProperties[] = "invalid value for 'index', the character length must be smaller than or equal to 9.";
        }

        if (!is_null($this->container['index']) && (mb_strlen($this->container['index']) < 0)) {
            $invalidProperties[] = "invalid value for 'index', the character length must be bigger than or equal to 0.";
        }
    ...
    public function setIndex($index)
    {
        ...
        if (!is_null($index) && (mb_strlen($index) > 9)) {
            throw new \InvalidArgumentException('invalid length for $index when calling Components., must be smaller than or equal to 9.');
        }
        if (!is_null($index) && (mb_strlen($index) < 0)) {
            throw new \InvalidArgumentException('invalid length for $index when calling Components., must be bigger than or equal to 0.');
        }
