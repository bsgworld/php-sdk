 ...
 */
class SendRcsCampaign implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SendRcsCampaign';
    ...
    */
    ...
    public function setPhones($phones)
    {
        ...
        if ((count($phones) > 5000)) {
            throw new \InvalidArgumentException('invalid value for $phones when calling SendRcsCampaign., number of items must be less than or equal to 5000.');
        }
        if ((count($phones) < 1)) {
            throw new \InvalidArgumentException('invalid length for $phones when calling SendRcsCampaign., number of items must be greater than or equal to 1.');
        }
    ...
    public function setSender($sender)
    {
        ...
        if ((mb_strlen($sender) > 40)) {
            throw new \InvalidArgumentException('invalid length for $sender when calling SendRcsCampaign., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($sender) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sender when calling SendRcsCampaign., must be bigger than or equal to 1.');
        }
    ...
    public function setValidity($validity)
    {
        ...
        if (($validity > 72)) {
            throw new \InvalidArgumentException('invalid value for $validity when calling SendRcsCampaign., must be smaller than or equal to 72.');
        }
        if (($validity < 1)) {
            throw new \InvalidArgumentException('invalid value for $validity when calling SendRcsCampaign., must be bigger than or equal to 1.');
        }
