...
/**
 * SmsAltChannel Class Doc Comment
 *
 * @category Class
 ...
 */
class SmsAltChannel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SmsAltChannel';
    ...
    */
    ...
    public function setText($text)
    {
        ...
        if ((mb_strlen($text) > 765)) {
            throw new \InvalidArgumentException('invalid length for $text when calling SmsAltChannel., must be smaller than or equal to 765.');
        }
    ...
    public function setValiditySeconds($validity_seconds)
    {
        ...
        if (!is_null($validity_seconds) && ($validity_seconds > 86400)) {
            throw new \InvalidArgumentException('invalid value for $validity_seconds when calling SmsAltChannel., must be smaller than or equal to 86400.');
        }
        if (!is_null($validity_seconds) && ($validity_seconds < 30)) {
            throw new \InvalidArgumentException('invalid value for $validity_seconds when calling SmsAltChannel., must be bigger than or equal to 30.');
        }
    ...
    public function setValidity($validity)
    {
        ...
        if (($validity > 72)) {
            throw new \InvalidArgumentException('invalid value for $validity when calling SmsAltChannel., must be smaller than or equal to 72.');
        }
        if (($validity < 1)) {
            throw new \InvalidArgumentException('invalid value for $validity when calling SmsAltChannel., must be bigger than or equal to 1.');
        }
